...
let ContainComponent = class ContainComponent {
    constructor(_servicio) {
        this._servicio = _servicio;
    }
    doLogin() {
        let user1 = document.querySelectorAll("#login")[0].value;
        let pass1 = document.querySelectorAll("#password")[0].value;
...
ContainComponent.ctorParameters = () => [
    { type: _servicio_service__WEBPACK_IMPORTED_MODULE_2__["ServicioService"] }
];
